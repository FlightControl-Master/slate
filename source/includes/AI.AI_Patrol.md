...
The [AI_PATROL_ZONE](#ai_patrol_zone-class) class implements the core functions to patrol a [Zone](#zone-module) by an AI [Controllable](#controllable-module) or [Group](#group-module).
