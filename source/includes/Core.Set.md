...
* Manually managed using the **:Add...()** or **:Remove...()** methods. The initial SET can be filtered with the **[SET_BASE:FilterOnce()](#set_base-filteronce)** method
...
Create a new SET_GROUP object with the [SET_GROUP:New()](#set_group-new) method:

* [SET_GROUP:New()](#set_group-new): Creates a new SET_GROUP object.
...
* [SET_GROUP:FilterStart()](#set_group-filterstart): Starts the filtering of the groups within the SET_GROUP and add or remove GROUP objects **dynamically**.
...
Create a new SET_UNIT object with the [SET_UNIT:New()](#set_unit-new) method:

* [SET_UNIT:New()](#set_unit-new): Creates a new SET_UNIT object.
...
* [SET_UNIT:FilterStart()](#set_unit-filterstart): Starts the filtering of the units within the SET_UNIT.
...
Create a new SET_CLIENT object with the [SET_CLIENT:New()](#set_client-new) method:

* [SET_CLIENT:New()](#set_client-new): Creates a new SET_CLIENT object.
...
* [SET_CLIENT:FilterStart()](#set_client-filterstart): Starts the filtering of the clients within the SET_CLIENT.
...
Create a new SET_AIRBASE object with the [SET_AIRBASE:New()](#set_airbase-new) method:

* [SET_AIRBASE:New()](#set_airbase-new): Creates a new SET_AIRBASE object.
...
* [SET_AIRBASE:FilterStart()](#set_airbase-filterstart): Starts the filtering of the airbases within the SET_AIRBASE.
