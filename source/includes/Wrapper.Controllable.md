...
* [CONTROLLABLE:TaskAttackMapObject()](#controllable-taskattackmapobject-vec2-groupattack-weaponexpend-attackqty-direction-altitude-weapontype): (AIR) Attacking the map object (building, structure, e.t.c).
...
* [CONTROLLABLE:TaskBombing()](#controllable-taskbombing-vec2-groupattack-weaponexpend-attackqty-direction-altitude-weapontype): (AIR) Delivering weapon at the point on the ground.
